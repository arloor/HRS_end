...
public class ManagerMysqlDataHelperTest {
    ...
    public void testInsertManager() {
        /*
        ManagerPO mpo = new ManagerPO(ManagerType.HotelWorker, "salesMan01", "123", "15050586180", "如家酒店（仙林）");
    ...
    public void testFindManagerInfo() {
        /*
        Map<String, ManagerPO> managerPOMap = managerMysqlDataHelper.findManagerInfo(ManagerType.WebManager);
